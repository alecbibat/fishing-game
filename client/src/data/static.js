...
export const ABILITIES = [
  ...
  { lvl: 13, name: 'Steady Wrist',     desc: 'The timing marker sweeps slower.', fx: { stability: 0.06 } },
  { lvl: 15, name: 'Hotspot Sense',    desc: 'You can feel bubbling hotspots from further away.', fx: { hotspot: 1 } },
  { lvl: 18, name: 'Wider Net',        desc: 'A wider golden catch zone.', fx: { barSize: 0.06 } },
  ...
  { lvl: 35, name: 'Tension Control',  desc: 'Your line forgives a mistimed pull.', fx: { tension: 0.1 } },
  ...
  { lvl: 85, name: 'Iron Line',        desc: 'An unbreakable second chance on the line.', fx: { tension: 0.12 } },
