...
export const ABILITIES = [
  ...
  { lvl: 13, name: 'Steady Wrist',     desc: 'The catch bar drifts less.', fx: { stability: 0.06 } },
  { lvl: 15, name: 'Hotspot Sense',    desc: 'You can feel bubbling hotspots from further away.', fx: { hotspot: 1 } },
  { lvl: 18, name: 'Wider Net',        desc: 'Bigger catch bar.', fx: { barSize: 0.06 } },
  ...
  { lvl: 35, name: 'Tension Control',  desc: 'Line tension climbs slower.', fx: { tension: 0.1 } },
  ...
  { lvl: 85, name: 'Iron Line',        desc: 'Line tension climbs much slower.', fx: { tension: 0.12 } },
